...
walk1 = Walk.create(dogwalker: "Max", starttime: "12:00",  length: "15 minutes", dog_id: dog4.id)
walk2 = Walk.create(dogwalker: "Nate", starttime: "10:00",  length: "30 minutes", dog_id: dog1.id)
walk3 = Walk.create(dogwalker: "Kevin", starttime: "12:00",  length: "15 minutes", dog_id: dog3.id)
